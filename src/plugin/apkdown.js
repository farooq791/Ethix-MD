          ...
          message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
              body: proto.Message.InteractiveMessage.Body.create({
                text: `𝙁𝘼𝙍𝙊𝙊𝙌_𝘽𝘼𝙇𝙊𝘾𝙃 APK Downloader\n\n🔍 Search and download your favorite APKs easily.\n\n📌 Simply select an APK from the list below to get started.\n\n`
              }),
              footer: proto.Message.InteractiveMessage.Footer.create({
                text: "© Powered By 𝙁𝘼𝙍𝙊𝙊𝙌_𝘽𝘼𝙇𝙊𝘾𝙃"
              }),
              header: proto.Message.InteractiveMessage.Header.create({
                ...(await prepareWAMessageMedia({ image: { url: `https://telegra.ph/file/4d123676cefca6138302c.jpg` } }, { upload: Matrix.waUploadToServer })),
                title: ``,
                gifPlayback: true,
                subtitle: "",
